    ...
    <li>
      ...
      <div>
        ...
        <p>
          ...
          имеет достаточно свободного времени, чтобы пройти полый базовый курс.
          В сжатые сроки вы получаете основную необходимую информацию для работы
          визажистом.
        </p>
        <button>
    ...
    <li>
      ...
      <div>
        ...
        <p>
          ...
          пройденной ранее базы; а также желающих научиться создавать креативные
          образы.
        </p>
        <button>
    ...
    <li>
      ...
      <div>
        ...
        <p>
          ...
          своего лица, правильно подбирать и использовать подходящую именно Вам
          косметику.
        </p>
        <button>
          <Link className={link} to="/education/makeup_for_yourself_course">
            Все о курсе
          </Link>
        </button>
      </div>
